...
var AmexExpressCheckoutCard, AndroidPayCard, ApplePayCard, AttributeSetter, CoinbaseAccount, CreditCard, Customer, PayPalAccount,
...
Customer = (function(_super) {
  ...
  function Customer(attributes) {
    var cardAttributes, coinbaseAccountAttributes, paymentMethod, paypalAccountAttributes, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _len5, _m, _n, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
    ...
    if (attributes.amexExpressCheckoutCards) {
      this.amexExpressCheckoutCards = (function() {
        ...
        _ref3 = attributes.amexExpressCheckoutCards;
        _results = [];
        for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
          cardAttributes = _ref3[_l];
          _results.push(new AmexExpressCheckoutCard(cardAttributes));
        }
        return _results;
      })();
      _ref3 = this.amexExpressCheckoutCards;
      for (_l = 0, _len3 = _ref3.length; _l < _len3; _l++) {
    ...
    if (attributes.paypalAccounts) {
      this.paypalAccounts = (function() {
        ...
        _ref4 = attributes.paypalAccounts;
        _results = [];
        for (_m = 0, _len4 = _ref4.length; _m < _len4; _m++) {
          paypalAccountAttributes = _ref4[_m];
          _results.push(new PayPalAccount(paypalAccountAttributes));
        }
        return _results;
      })();
      _ref4 = this.paypalAccounts;
      for (_m = 0, _len4 = _ref4.length; _m < _len4; _m++) {
    ...
    if (attributes.coinbaseAccounts) {
      this.coinbaseAccounts = (function() {
        ...
        _ref5 = attributes.coinbaseAccounts;
        _results = [];
        for (_n = 0, _len5 = _ref5.length; _n < _len5; _n++) {
          coinbaseAccountAttributes = _ref5[_n];
          _results.push(new CoinbaseAccount(coinbaseAccountAttributes));
        }
        return _results;
      })();
      _ref5 = this.coinbaseAccounts;
      for (_n = 0, _len5 = _ref5.length; _n < _len5; _n++) {
        paymentMethod = _ref5[_n];
        this.paymentMethods.push(paymentMethod);
      }
    }
  }
